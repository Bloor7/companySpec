...
HÔM NAY logic này nằm rải trong `gateway/cli/dispatch.py:cmd_call`, trộn với việc mở
...
⚠ FILE NÀY CHƯA THAY THẾ `gateway/cli/dispatch.py`. Nó là bản bóc ra để kiểm được;
